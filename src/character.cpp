...
void ofw::scene::Character::set_height(unsigned int height) {
...
void ofw::scene::Character::set_width(unsigned int width) {
...
void ofw::scene::Character::set_life(unsigned int life) {
...
void ofw::scene::Character::set_rel_height(int rel_height) {
...
void ofw::scene::Character::set_rel_width(int rel_width) {
...
void ofw::scene::Character::set_rel_life(int rel_life) {
...
irr::scene::IAnimatedMeshSceneNode* ofw::scene::Character::render(irr::IrrlichtDevice *device) {
...
void ofw::scene::Character::refresh_character() {
    float percent = 100;
    if (!this->character)
        return;
...
void ofw::scene::Character::set_animation(unsigned int init_frame, unsigned int end_frame,
        unsigned int speed) {
    character->setFrameLoop(0, 13);  // nº frame
    character->setAnimationSpeed(10); // fps
}

void ofw::scene::Character::change_mesh(bool sig) {
    int tam = MESHES.size();
    if (sig)
...
void ofw::scene::Character::change_texture(bool sig) {
